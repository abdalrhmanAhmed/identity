...
<aside class="app-sidebar sidebar-scroll">
	<div class="main-sidebar-header active">
							<a href="{{ url('/' . $page='home') }}"><img src="{{URL::asset('assets/img/brand/main-.png')}}" class="dark-logo-2" alt="logo"></a>
		<a class="desktop-logo logo-light active" href="{{ url('/' . $page='home') }}"><img src="{{URL::asset('assets/img/brand/main-logo.png')}}" class="main-logo ht-50" alt="logo"></a>
		...
		<a class="logo-icon mobile-logo icon-light active" href="{{ url('/' . $page='home') }}"><img src="{{URL::asset('assets/img/brand/main-logo.png')}}" class="logo-icon" alt="logo"></a>
	...
	<div class="main-sidemenu">
		...
		<ul class="side-menu">
			...
			@endcan
			@can("tecket_maker")
			<li class="side-item side-item-category">المستشفى</li>

			<li class="slide">
				<a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}"><svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24"><path d="M0 0h24v24H0V0z" fill="none"/><path d="M19 5H5v14h14V5zM9 17H7v-7h2v7zm4 0h-2V7h2v10zm4 0h-2v-4h2v4z" opacity=".3"/><path d="M3 5v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2H5c-1.1 0-2 .9-2 2zm2 0h14v14H5V5zm2 5h2v7H7zm4-3h2v10h-2zm4 6h2v4h-2z"/></svg><span class="side-menu__label">ملفات الولادة و الوفاة</span><i class="angle fe fe-chevron-down"></i></a>
				<ul class="slide-menu">
					<li><a class="slide-item" href="{{ route('barthdoc') }}">الملفات</a></li>
				</ul>
			</li>
			@endcan
			@can("tecket_maker")
			<li class="side-item side-item-category">إنشاء الملفات</li>

			<li class="slide">
				<a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}"><svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24"><path d="M0 0h24v24H0V0z" fill="none"/><path d="M19 5H5v14h14V5zM9 17H7v-7h2v7zm4 0h-2V7h2v10zm4 0h-2v-4h2v4z" opacity=".3"/><path d="M3 5v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2H5c-1.1 0-2 .9-2 2zm2 0h14v14H5V5zm2 5h2v7H7zm4-3h2v10h-2zm4 6h2v4h-2z"/></svg><span class="side-menu__label">إنشاء الملفات</span><i class="angle fe fe-chevron-down"></i></a>
				<ul class="slide-menu">
					<li><a class="slide-item" href="{{ route('profile.index') }}">الملفات</a></li>
				</ul>
			</li>
			@endcan
			@can("parsones_recorde")
			<li class="side-item side-item-category">السجل المدني</li>

			<li class="slide">
				<a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}"><svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24"><path d="M0 0h24v24H0V0z" fill="none"/><path d="M19 5H5v14h14V5zM9 17H7v-7h2v7zm4 0h-2V7h2v10zm4 0h-2v-4h2v4z" opacity=".3"/><path d="M3 5v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2H5c-1.1 0-2 .9-2 2zm2 0h14v14H5V5zm2 5h2v7H7zm4-3h2v10h-2zm4 6h2v4h-2z"/></svg><span class="side-menu__label">سجل المواليد و الوفيات</span><i class="angle fe fe-chevron-down"></i></a>
				<ul class="slide-menu">
					<li><a class="slide-item" href="{{ route('barthHome') }}"> قائمة  سجل المواليد </a></li>
					<li><a class="slide-item" href="{{ route('dathindex') }}"> قائمة  سجل الوفيات </a></li>
				</ul>
			@endcan
			@can("parsones_recorde")
			<li class="side-item side-item-category">مركز المقارنة</li>

			<li class="slide">
				<a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}"><svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24"><path d="M0 0h24v24H0V0z" fill="none"/><path d="M19 5H5v14h14V5zM9 17H7v-7h2v7zm4 0h-2V7h2v10zm4 0h-2v-4h2v4z" opacity=".3"/><path d="M3 5v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2H5c-1.1 0-2 .9-2 2zm2 0h14v14H5V5zm2 5h2v7H7zm4-3h2v10h-2zm4 6h2v4h-2z"/></svg><span class="side-menu__label"> مركز المقارنة</span><i class="angle fe fe-chevron-down"></i></a>
				<ul class="slide-menu">
					<li><a class="slide-item" href="{{ route('watcerIndex') }}"> مركز المقارنة</a></li>
				</ul>
			@endcan
			@can("settinges")
			<li class="side-item side-item-category">الاعدادات</li>
				@can("data_entry")
				<li class="slide">
					<a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}"><svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24"><path d="M0 0h24v24H0V0z" fill="none"/><path d="M19 5H5v14h14V5zM9 17H7v-7h2v7zm4 0h-2V7h2v10zm4 0h-2v-4h2v4z" opacity=".3"/><path d="M3 5v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2H5c-1.1 0-2 .9-2 2zm2 0h14v14H5V5zm2 5h2v7H7zm4-3h2v10h-2zm4 6h2v4h-2z"/></svg><span class="side-menu__label">البيانات الأولية</span><i class="angle fe fe-chevron-down"></i></a>
					<ul class="slide-menu">
						<li><a class="slide-item" href="{{ url('record/countryBirth') }}">قائمة الدول</a></li>
						<li><a class="slide-item" href="{{ url('record/States') }}">قائمة الولايات</a></li>
						<li><a class="slide-item" href="{{ url('record/locales') }}">قائمة المحليات</a></li>
						<li><a class="slide-item" href="{{ url('record/town') }}">قائمة المدن</a></li>
						<li><a class="slide-item" href="{{ url('record/AdministrativeUnits') }}">قائمة الوحدات الإدارية</a></li>
						<li><a class="slide-item" href="{{ url('record/popularAdministrations') }}">قائمة الإدارات الشعبية</a></li>
						<li><a class="slide-item" href="{{ url('record/center') }}">قائمة المراكز</a></li>
						<li><a class="slide-item" href="{{ url('record/education') }}">قائمة المؤهل العلمي</a></li>
						<li><a class="slide-item" href="{{ url('record/failed/jobs') }}">قائمة التصنيف المهني</a></li>
						<li><a class="slide-item" href="{{ url('record/Profession') }}">قائمة المهن</a></li>
						<li><a class="slide-item" href="{{ url('record/Social_situation') }}">قائمة الحالات الإجتماعية</a></li>
						<li><a class="slide-item" href="{{ url('record/BloodType') }}">قائمة فصائل الدم</a></li>
						<li><a class="slide-item" href="{{ url('record/bankes') }}">قائمة البنوك</a></li>
					</ul>
				</li>
				@endcan
			@endcan
			...
			<li class="slide">
				...
				<ul class="slide-menu">
					<li><a class="slide-item" href="{{ route('reports.contrys') }}">تقارير الولايات</a></li>
					<li><a class="slide-item" href="{{ route('reports.agents') }}">تقارير العملاء</a></li>
				</ul>
			</li>
			@endcan
 ...
 <li><a class="sub-slide-item" href="{{ url('/' . $page='#') }}">Level02</a></li> 
			...
			<li class="slide">
				<a class="side-menu__item" href="http://127.0.0.1:8000/logout" 

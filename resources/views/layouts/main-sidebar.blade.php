	...
	<div class="main-sidemenu">
		...
		<ul class="side-menu">
			...
			<li class="slide">
				...
				<ul class="slide-menu">
					<li><a class="slide-item" href="{{ route('barthdoc') }}">ملفات الولادة</a></li>
					<li><a class="slide-item" href="{{ route('dathedoc') }}">ملفات الوفاة</a></li>
				</ul>
			</li>
			@endcan
			@can("tecket_maker")
			...
			<li class="slide">
				...
				<ul class="slide-menu">
					...
					<li><a class="slide-item" href="{{ url('record/Birthand') }}">قائمة المواليد و الوفيات</a></li>
				</ul>
			</li>
			<li class="slide">

					...
					<div class="main-header-right">
							...
							{{-- <li class="">
								<div class="dropdown  nav-itemd-none d-md-flex">
									<a href="#" class="d-flex  nav-item nav-link pl-0 country-flag1" data-toggle="dropdown" aria-expanded="false">
										<span class="avatar country-Flag mr-0 align-self-center bg-transparent"><img src="{{URL::asset('assets/img/flags/flag_of_sudan.svg')}}" alt="img"></span>
										<div class="my-auto">
						...
						<div class="nav nav-item  navbar-nav-right ml-auto">
							...
							<div class="dropdown main-profile-menu nav nav-item nav-link">
								...
								<a class="profile-user d-flex" href=""><img alt="" src="{{URL::asset('assets/img/faces/default_female.png')}}"></a>
								@else
								<a class="profile-user d-flex" href=""><img alt="" src="{{URL::asset('assets/img/faces/default_male.jpg')}}"></a>
								@endif
								<div class="dropdown-menu">
									<div class="main-header-profile bg-primary p-3">
										<div class="d-flex wd-100p">
											@if(Auth::user()->hasRole('manager'))
											<div class="main-img-user"><img alt="" src="{{URL::asset('assets/img/faces/default_female.png')}}" class=""></div>												
											@else
											<div class="main-img-user"><img alt="" src="{{URL::asset('assets/img/faces/default_male.jpg')}}" class=""></div>
											@endif
									...
									<a class="dropdown-item" href=""><i class="bx bx-cog"></i>إعدادات الحساب</a>
									<a class="dropdown-item" href="{{ url('cp/' . $page='mail') }}"><i class="bx bxs-envelope"></i>البريد الإلكتروني</a>

					...
					<div class="main-header-right">
						...
						<div class="nav nav-item  navbar-nav-right ml-auto">
							...
							<div class="dropdown nav-item main-header-notification">
								...
								<div class="dropdown-menu">
									<div class="menu-header-content bg-primary text-right">
										...
										<p class="dropdown-title-text subtext mb-0 text-white op-6 pb-0 tx-12 ">You have 0 unread Notifications</p>
									</div>
							...
							<div class="dropdown main-profile-menu nav nav-item nav-link">
								@if($student->PHOTO)
								<a class="profile-user d-flex" href=""><img alt="" src="{{URL::asset($student->PHOTO)}}"></a>
								@else
								...
								<div class="dropdown-menu">
									<div class="main-header-profile bg-primary p-3">
										<div class="d-flex wd-100p">
											...
											@else
											<a class="profile-user d-flex" href=""><img alt="" src="{{URL::asset('assets/img/faces/default_male.jpg')}}"></a>
											@endif											<div class="mr-3 my-auto">
												<h6>{{Auth::user()->name}}</h6><span>{{Auth::user()->email}}</span>
											</div>
										</div>
									</div>
									<a class="dropdown-item" href="{{route('student.profile.show')}}"><i class="bx bx-user-circle"></i>الملف الشخصي</a>
									<a class="dropdown-item" href="{{route('student.profile.edit',Auth::user()->sno)}}"><i class="bx bx-cog"></i> تحديث الملف الشخصي</a>
									{{-- <a class="dropdown-item" href=""><i class="bx bxs-inbox"></i>Inbox</a>
									<a class="dropdown-item" href=""><i class="bx bx-envelope"></i>Messages</a> --}}
									<a class="dropdown-item" href="{{route('student.setting.show')}}"><i class="bx bx-slider-alt"></i> إعدادات الحساب</a>

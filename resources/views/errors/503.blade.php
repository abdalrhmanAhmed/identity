							...
							<div class="row">
								<div class="main-card-signin construction text-center border-0 mx-auto">
									<div class="p-4 wd-100p mx-auto">
										<div>
											<h2 class="tx-30">{{__('messages.Under-Maintenance')}}</h2>
											<p class="tx-12 text-muted">{{__('messages.Under-Maintenance-message')}}</p>
											<div class="row row-sm mx-auto">
												<div id="count-down" class="center-block mt-3 mb-3 mx-auto">
													<div class="clock-presenter days_dash">
														<div class="digit"></div>
														<div class="digit"></div>
														<p class="mt-2">{{__('messages.days')}}</p>
													</div>
													<div class="clock-presenter hours_dash">
														<div class="digit"></div>
														<div class="digit"></div>
														<p class="mt-2">{{__('messages.hours')}}</p>
													</div>
													<div class="clock-presenter minutes_dash">
														<div class="digit"></div>
														<div class="digit"></div>
														<p class="mt-2">{{__('messages.minutes')}}</p>
													</div>
													<div class="clock-presenter seconds_dash">
														<div class="digit"></div>
														<div class="digit"></div>
														<p class="mt-2">{{__('messages.seconds')}}</p>
													</div>
												</div>
											</div>

...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">البيانات الأولية</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ عمليات إنشاء المراكز</span>
						</div>
					</div>
				</div>
				<!-- breadcrumb -->
					...
					<div class="col-xl-12">
									...
									<table class="table text-md-nowrap" id="example1">
										<thead>
											<tr>
												...
												<th class="wd-25p border-bottom-0 text-center">إسم المحلية</th>
						...
						<div class="modal" id="modaldemo8">
							<div class="modal-dialog modal-dialog-centered" role="document">
								<div class="modal-content modal-content-demo">
									<div class="modal-header">
										<h6 class="modal-title">إضافة مركز جديد</h6><button aria-label="Close" class="close" data-dismiss="modal" type="button"><span aria-hidden="true">&times;</span></button>
									</div>

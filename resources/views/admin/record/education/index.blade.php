...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">السجل المدني</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ قائمة المؤهل العلمي</span>
						</div>
					</div>
				</div>
				<!-- breadcrumb -->
							...
							<div class="card-body">
								<div class="table-responsive">
									<table class="table mg-b-0 text-md-nowrap table-hover " id="datatable">
										...
										<tbody>
											@foreach ($educationName as $key => $name)
												<tr>
													...
													<td>
														...
														@if ($name->name !== 'Admin')
															@can('permission-delete')
																{!! Form::open(['method' => 'DELETE', 'route' => ['education.destroy',
												...
												<div class="modal" id="edit{{ $name->id }}">
													<div class="modal-dialog modal-dialog-centered" role="document">
														<div class="modal-content modal-content-demo">
															...
															<form action="{{ route('education.edit', $name->id) }}" method="PUT">
																{{ csrf_field() }}
																@method('put')

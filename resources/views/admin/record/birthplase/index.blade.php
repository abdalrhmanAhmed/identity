...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">السجل المدني</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ قائمة مكان الميلاد</span>
						</div>
					</div>
				</div>
				<!-- breadcrumb -->
				...
				<div class="row">
							...
							<div class="card-body">
								<div class="table-responsive">
									<table class="table mg-b-0 text-md-nowrap table-hover " id="datatable">
										...
										<tbody>
											@foreach ($BirthName as $key => $birth_palce_name)
												<tr>
					...
					<!-- End Modal effects-->
						...
						<div class="modal" id="modaldemo8">
							<div class="modal-dialog modal-dialog-centered" role="document">
								<div class="modal-content modal-content-demo">
									<form action="{{ route('birthPlace.store') }}" method="POST">
										{{ csrf_field() }}
										<div class="modal-body">
											<label for=""> مكان الميلاد</label>
											<input type="text" name="birth_palce_name" class="form-control">
										</div>
										<div class="modal-footer">
											<button class="btn ripple btn-primary btn-sm" type="submit">حفظ</button>
											<button class="btn ripple btn-secondary btn-sm" data-dismiss="modal" type="button">إلغاء</button>

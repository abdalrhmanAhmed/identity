						...
						<div class="card">
							<div class="card-body">
								...
								<div class="tab-content border-left border-bottom border-right border-top-0 p-4">
									@include('admin.record.profiles.edit_profile.personal_information')
									@include('admin.record.profiles.edit_profile.id_information')
									@include('admin.record.profiles.edit_profile.disability_information')
									@include('admin.record.profiles.edit_profile.witness_information')
									@include('admin.record.profiles.edit_profile.marry_information')
								</div>
							</div>
						</div>
					</div>

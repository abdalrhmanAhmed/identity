...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">السجل المدني</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ قائمة الحالات الإجتماعية</span>
						</div>
					</div>
				</div>
				<!-- breadcrumb -->
									...
									<table class="table mg-b-0 text-md-nowrap table-hover " id="datatable">
										<thead>
											<tr>
												...
												<th>#</th>
												<th>إسم الحالة الإجتماعية</th>
												<th>العمليات</th>
											</tr>
										</thead>
										<tbody>
											@foreach ($SocialSituation as $key => $name)
												<tr>
													...
													<td>
														...
														{{--  --}}
															...
															@can('user-delete')
																{!! Form::open(['method' => 'DELETE', 'route' => ['Social_situation.destroy',
												...
												<div class="modal" id="edit{{ $name->id }}">
													<div class="modal-dialog modal-dialog-centered" role="document">
														<div class="modal-content modal-content-demo">
															...
															<form action="{{ route('Social_situation.edit', $name->id) }}" method="PUT">
																{{ csrf_field() }}
																@method('put')
																<div class="modal-body">
																	<label for="">إسم الصلاحية</label>
																	<input type="text" name="s_name" value="{{ $name->s_name }}" class="form-control">
																</div>
					...
					<!-- End Modal effects-->
						...
						<div class="modal" id="modaldemo8">
							<div class="modal-dialog modal-dialog-centered" role="document">
								<div class="modal-content modal-content-demo">
									<div class="modal-header">
										<h6 class="modal-title">إضافة حالة إجتماعية جديدة</h6><button aria-label="Close" class="close" data-dismiss="modal" type="button"><span aria-hidden="true">&times;</span></button>
									</div>
									<form action="{{ route('Social_situation.store') }}" method="POST">
										{{ csrf_field() }}
										<div class="modal-body">
											<label for="">إسم الحالة الإجتماعية</label>

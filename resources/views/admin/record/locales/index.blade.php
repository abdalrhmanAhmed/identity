...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">السجل المدني</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/قائمة المحليات</span>
						</div>
					</div>
				</div>
				<!-- breadcrumb -->
												...
												<tr>
													...
													<td>
                                                        ...
                                                        @can('permission-delete')
                                                            {!! Form::open(['method' => 'DELETE', 'route' => ['locales.destroy',
													...
													<div class="modal-dialog modal-dialog-centered" role="document">
														<div class="modal-content modal-content-demo">
															<div class="modal-header">
																<h6 class="modal-title">تعديل إسم المحليه</h6><button aria-label="Close" class="close" data-dismiss="modal" type="button"><span aria-hidden="true">&times;</span></button>
															</div>
															<form action="{{ route('locales.edit', $name->id) }}" method="PUT">
																{{ csrf_field() }}
																@method('PUT')
																<div class="modal-body">
																	<label for="">إسم المحلية</label>
																	<input type="text" name="local_name" value="{{ $name->local_name }}" class="form-control">
																</div>
					...
					<!-- End Modal effects-->
						...
						<div class="modal" id="modaldemo8">
							<div class="modal-dialog modal-dialog-centered" role="document">
								<div class="modal-content modal-content-demo">
									<div class="modal-header">
										<h6 class="modal-title">إضافة إسم المحلية جديد</h6><button aria-label="Close" class="close" data-dismiss="modal" type="button"><span aria-hidden="true">&times;</span></button>
									</div>
									<form action="{{ route('locales.store') }}" method="POST">
										...
										<div class="modal-body">
											...
											<select name="istate_id" id="select-beast" class="form-control" data-parsley-class-handler="#lnWrapper" required="">
												@foreach ($statesName as $item)

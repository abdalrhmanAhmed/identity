...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">السجل المدني</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ قائمة فصيلة الدم</span>
						</div>
					</div>
				</div>
				<!-- breadcrumb -->
											...
											@foreach ($BloodName as $key => $name)
												<tr>
													...
													<td>
														...
														@endcan
														{{--  --}}
														@if ($name->name !== 'BloodType')
															@can('permission-delete')
																{!! Form::open(['method' => 'DELETE', 'route' => ['BloodType.destroy',
												...
												<div class="modal" id="edit{{ $name->id }}">
													<div class="modal-dialog modal-dialog-centered" role="document">
														<div class="modal-content modal-content-demo">
															...
															<form action="{{ route('BloodType.edit', $name->id) }}" method="PUT">
																{{ csrf_field() }}
																@method('put')
					...
					<!-- End Modal effects-->
						...
						<div class="modal" id="modaldemo8">
							<div class="modal-dialog modal-dialog-centered" role="document">
								<div class="modal-content modal-content-demo">
									<div class="modal-header">
										<h6 class="modal-title">إضافة فصيلة الدم</h6><button aria-label="Close" class="close" data-dismiss="modal" type="button"><span aria-hidden="true">&times;</span></button>
									</div>

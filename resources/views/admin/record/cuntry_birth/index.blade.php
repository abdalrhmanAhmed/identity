...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">السجل المدني</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/قائمة الدول</span>
						</div>
					</div>
				</div>
				<!-- breadcrumb -->
							...
							<div class="card-body">
								<div class="table-responsive">
									<table class="table mg-b-0 text-md-nowrap table-hover " id="datatable">
										...
										<tbody>
											@foreach ($CountryName as $key => $name)
												<tr>
													...
													<td>
                                                        ...
                                                        @can('permission-delete')
                                                            {!! Form::open(['method' => 'DELETE', 'route' => ['countryBirth.destroy',
													...
													<div class="modal-dialog modal-dialog-centered" role="document">
														<div class="modal-content modal-content-demo">
															<div class="modal-header">
																<h6 class="modal-title">تعديل  الدولة</h6><button aria-label="Close" class="close" data-dismiss="modal" type="button"><span aria-hidden="true">&times;</span></button>
															</div>
															<form action="{{ route('countryBirth.edit', $name->id) }}" method="PUT">
																{{ csrf_field() }}
																@method('PUT')
																<div class="modal-body">
																	<label for="">إسم الدولة</label>
																	<input type="text" name="c_name" value="{{ $name->c_name }}" class="form-control">
                                                                    <br>
                                                                    <label for="">كود الدولة</label>
																	<input type="text" name="s_key" value="{{ $name->s_key }}" class="form-control">
																</div>
					...
					<!-- End Modal effects-->
						...
						<div class="modal" id="modaldemo8">
							<div class="modal-dialog modal-dialog-centered" role="document">
								<div class="modal-content modal-content-demo">
									<div class="modal-header">
										<h6 class="modal-title">إضافة دولة جديد</h6><button aria-label="Close" class="close" data-dismiss="modal" type="button"><span aria-hidden="true">&times;</span></button>
									</div>
									<form action="{{ route('countryBirth.store') }}" method="POST">
										{{ csrf_field() }}
										<div class="modal-body">
											<label for="">إسم الدولة</label>
                                            ...
                                            <br>
                                            <label for="">كود الدولة</label>
											<input type="text" name="s_key" class="form-control" required>
										</div>
										<div class="modal-footer">
